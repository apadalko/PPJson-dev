...
-(NSMutableAttributedString *)topTitleWithText:(NSString*)text{
    ...
    [topAttr ppj_findAndSelect:@"@" color:[UIColor colorFromHexString:@"666666"]
                          font:[UIFont muesoRounded1000WithSize:21]   removeFinder:YES];
...
-(void)_coreChat_1_0{
    ...
    [cb setAttrString:[self topTitleWithText:[@"loc.auth.welcome.title" localized]]];
...
-(void)_coreChat_1_1{
    ...
    [cb setAttrString:[self topTitleWithText:[@"loc.auth.welcome.title2" localized]]];
...
-(void)cs_1{
    ...
    [self _chatBubbleWithText:[@"loc.intro.chat.1" localized] onPersona:self.hamster andTime:3.1];
...
-(void)cs_2{
    ...
    [self _chatBubbleWithText:[@"loc.intro.chat.2" localized] onPersona:self.owl andTime:3.1];
...
-(void)cs_3{
    ...
    [self _chatBubbleWithText:[@"loc.intro.chat.3" localized] onPersona:self.hamster andTime:3.1];
...
-(void)cs_4{
    ...
    [self _chatBubbleWithText:[@"loc.intro.chat.4" localized] onPersona:self.owl andTime:3.1];
...
-(void)cs_5{
    ...
    [self _chatBubbleWithText:[@"loc.intro.chat.5" localized] onPersona:self.hamster andTime:4.1];
