...
-(void)viewDidLoad{
    ...
    if (titleAttrStr) {
        ...
        CGSize s = CGSizeMake(0, 20);
//        CGSize s  = [SATextHelper sizeOfString:titleAttrStr withSize:CGSizeMake([UIScreen mainScreen].bounds.size.width-self.screenInsets.left-self.screenInsets.right, CGFLOAT_MAX)];
...
//        [self setRightButtonItemWithOffset:-10 andButton:nextButton];
