...
//    [str ppm_findAndSelect:@"@" color:[UIColor colorFromHexString:@"4d4d4d"] font:[UIFont muesoRounded900WithSize:15] removeFinder:NO];
//        [str ppm_findAndSelect:@"#" color:[UIColor colorFromHexString:@"4d4d4d"] font:[UIFont muesoRounded900WithSize:15] removeFinder:YES];
